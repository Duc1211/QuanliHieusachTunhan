...
public class ChucNangC extends JFrame implements ActionListener,MouseListener
{
	...
	private JButton btnThemKH, btnThemNhanVien, btnSach, btnDCHT, btnHoaDon, btnDSHD;
	JPanel pnSach;
	...
	public ChucNangC(String maNV) throws Exception 
	{
...
//		btnThemKH.setPreferredSize(btnQLKH.getPreferredSize());
		btnThemKH.setPreferredSize(new Dimension(140, 30));
		
		btnThemNhanVien = new JButton();
		btnThemNhanVien.setBackground(Color.white);
		btnThemNhanVien.setPreferredSize(btnThemKH.getPreferredSize());
		
		btnSach = new JButton();
		btnSach.setFocusPainted(false);
		btnSach.setLayout(new BorderLayout());
		btnSach.setBackground(Color.white);
		btnSach.setPreferredSize(btnThemKH.getPreferredSize());
		btnSach.hide();
		...
		btnDCHT.setPreferredSize(btnThemKH.getPreferredSize());
		btnDCHT.hide();
		...
		btnHoaDon.setPreferredSize(btnThemKH.getPreferredSize());
		btnHoaDon.hide();
		...
		btnDSHD.setPreferredSize(btnThemKH.getPreferredSize());
		btnDSHD.hide();
		
		btnThongKe.setPreferredSize(btnThemKH.getPreferredSize());
//		=====================================
	...
	public static void main(String[] args) throws Exception {
		new ChucNangC("NV001").setVisible(true);
	}
...
//			pnCenter.removeAll();
//			pnCenter.revalidate();
//			pnCenter.add(QuanLiSanPham.)
		}
		
		if(object.equals(btnQLKH)) 
		{
			if (btnThemKH.getText().length() == 0)
			{
				btnThemKH.show();
				btnThemKH.setText("Thêm Khách Hàng");
			}
			else if (btnThemKH.getText().length() > 0)
			{
				btnThemKH.hide();
				btnThemKH.setText("");
			}
		...
		{	
			if (btnThemNhanVien.getText().length() == 0)
			{
				btnThemNhanVien.setText("Thêm Nhân Viên");
				btnThemNhanVien.show();
				lblQLTK.setText("Thống Kê");
				btnThongKe.show();
			}
			else
			{
				btnThemNhanVien.setText("");
				btnThemNhanVien.hide();
				lblQLTK.setText("");
				btnThongKe.hide();
			}
